...
<div class="container-fluid text-white" style='background-color: #123;'>
    <div class="container-fluid pt-3 pb-2">
      <h1 id='header' class='display-4 m-auto pl-3 pr-3' style='width: fit-content;font-size: 35px;'>VIEW STUDENT CLASS WISE</h1>
    </div>
</div>
...
">
  <div class="container-fluid p-0 m-0 text-center">
    <div class='d-flex text-light bg-dark' style="justify-content: space-between" >
     ...
     <div class='text-center pl-0 pr-0 pt-1 pb-1 edit' style='visibility: hidden;'>EDIT</div>
    </div>

    <div class="container-fliud position-fixed w-100" style="height: calc(100vh - 180px);overflow-y: auto;">
...
if(isset($_POST['submit'])){
   ...
   // echo $name;
    //echo $std;
   $sql="select * from student where class='$std' ";
   ...
   if(mysqli_num_rows($res)<1){
    ...
    <div class='d-flex text-center border' style="justify-content: space-between; margin-right: 13.5px;" >
     ...
     <div class='text-center pl-0 pr-0 pt-1 pb-1 edit'><a class='fa fa-close btn text-primary' title='Delete' href="deletedata.php?sid=<?php echo $x['Id']?>"></a></div>
    </div>
